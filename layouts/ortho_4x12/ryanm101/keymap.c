...
// Community layout keymap for ortho_4x12 (JJ40 and similar planck-style boards)
// Build with: qmk compile -kb <your_ortho_4x12_board> -km ryanm101
// Or via GitHub Actions - see README.md
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_ortho_4x12(
        ...
        KC_NONUS_BSLASH, MO(_L1), KC_SPC, KC_SPC, MO(_L2), KC_LEFT, KC_DOWN,
        KC_UP, KC_RGHT),
    ...
    [_L2] = LAYOUT_ortho_4x12(
        KC_SYSREQ, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_NUM, KC_KP_7,
        KC_KP_8, KC_KP_9, KC_KP_ASTERISK, KC_BSPC, KC_NO, KC_F5, KC_F6, KC_F7,
        KC_F8, KC_NO, KC_NO, KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_SLASH, _______,
        KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_NO, KC_NO, KC_KP_1, KC_KP_2,
        KC_KP_3, KC_KP_PLUS, KC_KP_ENTER, _______, _______, _______, KC_NO,
        KC_NO, KC_SPC, KC_SPC, KC_NO, KC_KP_0, KC_KP_DOT, KC_KP_MINUS, _______),
    ...
    [_L3] = LAYOUT_ortho_4x12(
        RGB_TOG, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, KC_NO, KC_NO, KC_PGDN,
        KC_PGUP, KC_NO, KC_NO, KC_NO, BL_TOGG, BL_STEP, RGB_VAI, RGB_VAD,
        RGB_MOD, RGB_RMOD, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, TMUX,
